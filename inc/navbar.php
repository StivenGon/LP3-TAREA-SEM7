        ...
        <div class="col-xs-8">
            <div class="contenedor-tabla pull-right">
                <div class="contenedor-tr">
                    <a href="index.php" class="table-cell-td"><i class="fa fa-home"
                    ...
                    if (!$_SESSION['nombreAdmin'] == "") {
                        echo '
                        <a href="configAdmin.php" class="table-cell-td"><i class="fa fa-briefcase" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Administración</a>
                        ...
                        echo '
                        <a href="pedido.php" class="table-cell-td"><i class="fa fa-table" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Pedido</a>
                        <a href="#" class="table-cell-td carrito-button-nav all-elements-tooltip" data-toggle="tooltip" data-placement="bottom" title="Ver carrito de compras">
                            <i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;&nbsp;Carrito
                        </a>
                        <a href="#" class="table-cell-td" data-toggle="modal" data-target=".modal-logout">
                        ...
                        echo '
                        <a href="registration.php" class="table-cell-td"><i class="fa fa-pencil-square" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Registro</a>
                        <a href="#" class="table-cell-td carrito-button-nav all-elements-tooltip" data-toggle="tooltip" data-placement="bottom" title="Ver carrito de compras">
                            <i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;&nbsp;Carrito
                        </a>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content" id="modal-form-login">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center text-primary" id="myModalLabel">Iniciar sesión en LP3 Electronics
                </h4>
            </div>
            <form action="process/login.php" method="post" role="form" style="margin: 20px;" class="FormLP3"
                data-form="login">
                <div class="form-group">
                    <label><span class="glyphicon glyphicon-user"></span>&nbsp;Nombre</label>
                    <input type="text" class="form-control" name="nombre-login" placeholder="Escribe tu nombre"
                        required="" />
                </div>
                <div class="form-group">
...
Pedido</a></li>';
            ...
            echo '<li><a href="registration.php"><i class="fa fa-pencil-square" aria-
hidden="true"></i>
Registro</a></li>';
        }
        ?>
...
<!-- Modal carrito -->
<div class="modal fade modal-carrito" tabindex="-1" role="dialog" aria- labelledby="mySmallModalLabel"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <p class="text-center"><button type="button" class="btn btn-primary btn-sm" data-
                    dismiss="modal">Aceptar</button></p>
        </div>
    </div>
</div>
<!-- Fin Modal carrito -->
