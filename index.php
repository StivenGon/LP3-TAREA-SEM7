...
<body id="container-page-index">
    ...
    <div class="jumbotron" id="jumbotron-index">
        ...
        <p>
            Bienvenido a nuestra tienda en línea, aquí encontrará una gran variedad de artículos para el hogar.
        </p>
    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                    <article style="margin-top:20%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrese y haga cliente de <span class="tittles-pages-logo">LP3 Electronics</span> para
                            recibir las mejores ofertas y descuentos especiales de nuestros productos.</p>
