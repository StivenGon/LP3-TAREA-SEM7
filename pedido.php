    ...
    <section id="container-pedido">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6">
                    <div id="form-compra">
                        <form action="process/confirmcompra.php" method="post" role="form" class="FormLP3"
                            data-form="save">
                            <?php
                            if (!$_SESSION['nombreUser'] == "" && !$_SESSION['claveUser'] == "") {
                                ...
                                <p>
                                    Para confirmar tu compra debes haber iniciado sesión o introducir tu nombre de usuario
